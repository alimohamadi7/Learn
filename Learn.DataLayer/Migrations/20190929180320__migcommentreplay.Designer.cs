...
namespace Learn.DataLayer.Migrations
{
    ...
    [Migration("20190929180320__migcommentreplay")]
    partial class _migcommentreplay
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learn.DataLayer.Entities.Course.CourseComment", b =>
                {
                    ...
                    b.Property<int?>("CourseCommentCommentId");
                    ...
                    b.HasIndex("CourseCommentCommentId");
            ...
            modelBuilder.Entity("Learn.DataLayer.Entities.Course.ReplayCourseComment", b =>
                {
                    ...
                    b.HasKey("ReplayCommentId");

                    b.HasIndex("CommentId");

                    b.ToTable("ReplayCourseComments");
                });
            ...
            modelBuilder.Entity("Learn.DataLayer.Entities.Course.CourseComment", b =>
                {
                    b.HasOne("Learn.DataLayer.Entities.Course.CourseComment")
                        ...
                        .HasForeignKey("CourseCommentCommentId");
            ...
            modelBuilder.Entity("Learn.DataLayer.Entities.Course.ReplayCourseComment", b =>
                {
                    b.HasOne("Learn.DataLayer.Entities.Course.CourseComment", "CourseComment")
                        .WithMany()
